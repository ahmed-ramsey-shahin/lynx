...
namespace Lynx.IdentityService.Domain.Identity
{
    public sealed class RefreshToken
    {
        ...
        private RefreshToken(string id, string token, DateTimeOffset expiresOn)
        {
            Id = id;
            Token = token;
            ExpiresOn = expiresOn;
        ...
        public static Result<RefreshToken> Create(string id, string token, DateTimeOffset expiresOn)
        {
            ...
            return new RefreshToken(id, token, expiresOn);
        }
